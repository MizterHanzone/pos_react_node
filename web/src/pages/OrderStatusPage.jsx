...
const OrderStatus = () => {
    ...
    const onDelete = async (item) => {
        Modal.confirm({
            ...
            onOk: async () => {
                ...
                const res = await request("order_status/remove", "delete", data);
                if (res) {
    ...
    const onFinish = async (item) => {
        ...
        var url = (id == null ? "order_status/create" : "order_status/update");
    ...
    return (
        ...
        <MainPage loading={loading}>
            ...
            <Modal
                title={formRes.getFieldValue("id") == null ? "New OrderStatus" : "Edit OrderStatus"}
                open={open}
