...
const Category = () => {
    ...
    const onUpdate = (item) => {
        ...
        formRes.setFieldValue('description', item.description);
    ...
    const onDelete = async (item) => {
        Modal.confirm({
            ...
            onOk: async () => {
                ...
                const res = await request("category/remove", "delete", data);
                if (res) {
    ...
    return (
        ...
        <MainPage loading={loading}>
            ...
            <Modal
                title={formRes.getFieldValue("id") == null ? "New Category" : "Edit Category"}
                open={open}
