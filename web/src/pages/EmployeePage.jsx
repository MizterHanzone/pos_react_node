...
const Employees = () => {
    ...
    const getList = async () => {
        ...
        var param = {
            ...
            role_id: filter.current.role_id
        }
    ...
    const onUpdate = (item) => {
        ...
        formRes.setFieldValue('salary', item.salary);
        formRes.setFieldValue('roleId', item.roleId);
    ...
    const onDetails = (item) => {
        ...
        formRes.setFieldValue('address', item.address);
        formRes.setFieldValue('salary', '$' + item.salary);
        formRes.setFieldValue('roleId', item.roleName);
        formRes.setFieldValue('status', item.status + "");
        console.log(item);
    }
    ...
    const onDelete = async (item) => {
        Modal.confirm({
            ...
            onOk: async () => {
                ...
                const res = await request("employee/remove", "delete", data);
                if (res) {
    ...
    return (
        ...
        <MainPage loading={loading}>
            <div style={{ display: "flex", justifyContent: "space-between", margin: 20 }}>
                ...
                <div>
                    <Space>
                        ...
                        <Select onChange={onChangeStatus} placeholder="Select Status" allowClear >
                            <Select.Option value={"1"}>Active</Select.Option>
                            <Select.Option value={"0"}>Disable</Select.Option>
                        </Select>
                        <Select
                            style={{ width: "200px" }}
                            placeholder="Select Role for search"
                            showSearch
            ...
            <Modal
                title={formRes.getFieldValue("id") == null ? "New Employees" : "Edit Employees"}
                open={open}
