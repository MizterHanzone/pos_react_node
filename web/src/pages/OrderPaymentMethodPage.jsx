...
const OrderPaymentMethod = () => {
    ...
    const onDelete = async (item) => {
        Modal.confirm({
            ...
            onOk: async () => {
                ...
                const res = await request("order_payment_method/remove", "delete", data);
                if (res) {
    ...
    const onFinish = async (item) => {
        ...
        var url = (id == null ? "order_payment_method/create" : "order_payment_method/update");
    ...
    return (
        ...
        <MainPage loading={loading}>
            ...
            <Modal
                title={formRes.getFieldValue("id") == null ? "New OrderPaymentMethod" : "Edit OrderPaymentMethod"}
                open={open}
